...
public class Cannon0 : MonoBehaviour
{
    ...
    private void SavePosition()
    {
        ...
        if (key != "")
        {
            PlayerPrefs.SetFloat($"{key}XCannon0", position.x);
            PlayerPrefs.SetFloat($"{key}YCannon0", position.y);
            PlayerPrefs.SetFloat($"{key}ZCannon0", position.z);
            PlayerPrefs.Save();
        }
    }
    ...
    private void UpGradeDelete()
    {
        ...
        if (key != "")
        {
            ...
            PlayerPrefs.DeleteKey($"{key}XCannon0");
            PlayerPrefs.DeleteKey($"{key}YCannon0");
            PlayerPrefs.DeleteKey($"{key}ZCannon0");
            PlayerPrefs.Save();
