...
public class JustinBuilding1 : MonoBehaviour
{
    ...
    public GameObject JustinBuild2oj;
    ...
    private void CompleteConstruction()
    {
        ...
        PlayerPrefs.SetInt("JustinBuild1Active", 0);
        PlayerPrefs.Save();
        PlayerPrefs.SetInt("JustinBuild2Active", 1);
        PlayerPrefs.Save();
        JustinBuild2oj.SetActive(true);
        JustinBuild1oj.SetActive(false);
